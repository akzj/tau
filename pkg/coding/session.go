...
func NewCodingSession(ctx context.Context, opts CodingSessionOptions) (*CodingSession, error) {
	...
	cs.Tools.Register(tools.ApiSurfaceTool())
	cs.Tools.Register(tools.SemanticSearchTool())
	cs.Tools.Register(tools.FindDeadcodeTool())
	cs.Tools.Register(tools.DepGraphTool())
	cs.Tools.Register(tools.CIStatusTool())
	cs.Tools.Register(tools.ReleaseNotesTool())
	cs.Tools.Register(tools.PRReviewTool())
	cs.Tools.Register(tools.IssueTriageTool())
	cs.Tools.Register(tools.ChangelogTool())
	cs.Tools.Register(tools.LintCheckTool())
	cs.Tools.Register(tools.AuditLicenseTool())
	cs.Tools.Register(tools.CheckDocsTool())
	cs.Tools.Register(tools.ComplexityReportTool())
	cs.Tools.Register(tools.TestGapTool())
	cs.Tools.Register(tools.RaceCheckTool())
	cs.Tools.Register(tools.JSONSchemaTool())
	cs.Tools.Register(tools.SQLFromStructTool())
	cs.Tools.Register(tools.CSVAnalyzeTool())
	cs.Tools.Register(tools.MigrateDBTool())
	cs.Tools.Register(tools.BackupConfigTool())
	cs.Tools.Register(tools.DataDiffTool())
	cs.Tools.Register(tools.RefactorRenameTool())
	cs.Tools.Register(tools.ExtractFunctionTool())
	cs.Tools.Register(tools.InlineVariableTool())
	cs.Tools.Register(tools.GenerateInterfaceTool())
	cs.Tools.Register(tools.AddErrorWrappingTool())
	cs.Tools.Register(tools.GenerateMocksTool())
	cs.Tools.Register(tools.SecretScanTool())
	cs.Tools.Register(tools.DependencyAuditTool())
	cs.Tools.Register(tools.LicenseHeaderTool())
	cs.Tools.Register(tools.GitleaksScanTool())
	cs.Tools.Register(tools.SBOMGenerateTool())
	cs.Tools.Register(tools.ComplianceReportTool())
