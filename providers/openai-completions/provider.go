...
func (p *OpenAICompletionsProvider) parseSSE(ctx context.Context, body io.ReadCloser, events chan<- core.ProviderEvent) {
	...
	indexToID := make(map[int]string) // tool_calls index → actual call ID
