...
// Provider implements core.Provider for OpenAI Responses API.
...
// NewProvider creates an OpenAI Responses provider.
...
// Stream sends a Responses API request. API key is read per call.
...
// Complete sends a non-streaming Responses API request. API key is read per call.
