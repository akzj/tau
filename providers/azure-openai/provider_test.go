...
func TestNewProviderEnv(t *testing.T) {
	...
	os.Setenv("AZURE_OPENAI_ENDPOINT", "https://example.openai.azure.com/deployments/gpt4")
	_, err = NewProvider()
	if err == nil {
	...
	if prov.apiVersion != "2024-10-21" {
		t.Errorf("expected default apiVersion 2024-10-21, got %q", prov.apiVersion)
	}
	...
	if prov.apiVersion != "2025-01-01" {
		t.Errorf("expected apiVersion 2025-01-01, got %q", prov.apiVersion)
	}
}
